...
vspipe "$name.vpy" --y4m - | x264 --demuxer y4m --pass 1 --crf 18 --force-cfr --fps 59.94 --stats "$name.stats" --slow-firstpass --threads 8 --bframes 5 --b-adapt 2 --ref 4 --chroma-qp-offset -4 --rc-lookahead 48 --merange 32 --me tesa --direct auto --subme 11 --trellis 2 --psy-rd 0.00:0.15 --output "$name.h264" -
