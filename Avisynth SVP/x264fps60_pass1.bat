...
echo LWLibavVideoSource("%~dpn1%~x1").ConvertToYV12().Spline36Resize(1280,720) >> "%~dpn1.avs"
echo SetMTMode(2) >> "%~dpn1.avs"
echo InterFrame(Cores=Cores) >> "%~dpn1.avs"

"C:\Program Files (x86)\MeGUI_2715_x86\tools\x264\avs4x26x.exe" --x26x-binary "C:\Program Files (x86)\MeGUI_2715_x86\tools\x264\x264.exe" --pass 1 --crf 18 --stats "%~dpn1.stats" --slow-firstpass --threads 8 --bframes 5 --b-adapt 2 --ref 4 --chroma-qp-offset -4 --rc-lookahead 48 --merange 32 --me tesa --direct auto --subme 11 --trellis 2 --psy-rd 0.00:0.15 --output "%~dpn1_pass1.h264" "%~dpn1.avs"
