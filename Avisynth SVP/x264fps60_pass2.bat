...
"C:\Program Files (x86)\MeGUI_2715_x86\tools\x264\avs4x26x.exe" --x26x-binary "C:\Program Files (x86)\MeGUI_2715_x86\tools\x264\x264.exe" --pass 2 --bitrate 1800 --stats "%~dpn1.stats" --threads 8 --bframes 5 --b-adapt 0 --ref 4 --chroma-qp-offset -4 --rc-lookahead 48 --merange 32 --me tesa --direct auto --subme 11 --trellis 2 --psy-rd 0.00:0.15 --output "%~dpn1_pass2.h264" "%~dpn1.avs"
