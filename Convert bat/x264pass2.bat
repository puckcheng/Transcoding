...
"C:\Users\Puckcheng\AppData\Local\Programs\VapourSynth\core\vspipe.exe" "%~dpn1.vpy" --y4m - | "C:\Program Files (x86)\MeGUI\tools\x264\x264.exe" --demuxer y4m --preset veryslow --pass 2 --bitrate 2800 --stats "pass.stats" --deblock 1:0:0 --keyint 250 --vbv-bufsize 24000 --vbv-maxrate 20000 --threads 18 --bframes 12 --b-adapt 2 --ref 4 --qcomp 0.75 --qpmax 36 --chroma-qp-offset -4 --rc-lookahead 72 --merange 32 --me tesa --direct auto --range tv --colorprim bt709 --transfer bt709 --colormatrix bt709 --no-fast-pskip --subme 11 --trellis 2 --psy-rd 1.00:0.15 --input-depth 10 --level 4.1 --output "%~dpn1.h264" -
