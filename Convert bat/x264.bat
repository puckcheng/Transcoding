...
echo src=core.std.Trim(src,0,6559) >> "%~dpn1.vpy"
echo src=core.fmtc.resample(src,w=1920,h=1080,css="420",kernel="spline36") >> "%~dpn1.vpy"
...
"C:\Users\Puckcheng\AppData\Local\Programs\VapourSynth\core\vspipe.exe" "%~dpn1.vpy" --y4m - | "C:\Program Files (x86)\MeGUI\tools\x264\x264.exe" --demuxer y4m --preset veryslow --crf 18 --threads 18 --deblock 0:0 --bframes 12 --b-adapt 2 --b-pyramid normal --ref 4 --qcomp 0.75 --qpmax 36 --chroma-qp-offset -4 --rc-lookahead 72 --merange 32 --keyint 250 --min-keyint 1 --me tesa --direct auto --no-fast-pskip --subme 11 --trellis 2 --psy-rd 1.00:0.15 --input-depth 10 --output "%~dpn1.h264" -
